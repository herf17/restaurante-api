...
//        public clsUsuario1 insert_ususario()
//        {
...
//        public clsUsuario1 update_ususario()
//        {
//            clsConexion con = new clsConexion();
...
//        public List<clsUsuario1> BuscaUsuario()
//        {
//            clsConexion con = new clsConexion();
//            parametros.Add("p_id_usuario");
//            valores.Add(this.id_usuario);
//            this.listado = con.Ejecutar(sp_select_uno, parametros, valores);
//            List<clsUsuario1> lista = new List<clsUsuario1>();
//            if (!con.isError)
//                foreach (DataRow row in this.listado.Rows)
//                {
//                    lista.Add(new clsUsuario1
//                    {
...
//        public List<clsUsuario1> TodosUsuarios()
//        {
//            clsConexion con = new clsConexion();
