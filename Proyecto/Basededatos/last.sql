...
-- Volcando estructura para procedimiento db_a6aba0_herf.pa_agregar_puntos
DELIMITER //
...
-- Volcando estructura para procedimiento db_a6aba0_herf.pa_anular_orden
DELIMITER //
...
-- Volcando estructura para procedimiento db_a6aba0_herf.pa_cambio_estado_orden
DELIMITER //
...
-- Volcando estructura para procedimiento db_a6aba0_herf.pa_comprobar_puntos
DELIMITER //
...
-- Volcando estructura para procedimiento db_a6aba0_herf.pa_crear_orden
DELIMITER //
...
-- Volcando estructura para procedimiento db_a6aba0_herf.pa_end_orden
DELIMITER //
...
-- Volcando estructura para procedimiento db_a6aba0_herf.pa_insert_orden_detalle
DELIMITER //
...
-- Volcando estructura para procedimiento db_a6aba0_herf.pa_productos_enorden
DELIMITER //
...
-- Volcando estructura para procedimiento db_a6aba0_herf.pa_select_catg_prod
DELIMITER //
...
-- Volcando estructura para procedimiento db_a6aba0_herf.pa_select_orden_catg
DELIMITER //
...
-- Volcando estructura para procedimiento db_a6aba0_herf.pa_select_tbl_mesa
DELIMITER //
...
-- Volcando estructura para procedimiento db_a6aba0_herf.sp_agregar_usuario
DELIMITER //
...
-- Volcando estructura para procedimiento db_a6aba0_herf.sp_eliminar_categoria
DELIMITER //
...
-- Volcando estructura para procedimiento db_a6aba0_herf.sp_insertar_categoria
DELIMITER //
...
-- Volcando estructura para tabla db_a6aba0_herf.tbl_categoria
...
-- Volcando estructura para tabla db_a6aba0_herf.tbl_cliente
...
-- Volcando estructura para tabla db_a6aba0_herf.tbl_mesa
...
-- Volcando estructura para tabla db_a6aba0_herf.tbl_orden_detalle
...
-- Volcando estructura para tabla db_a6aba0_herf.tbl_orden_encabezado
...
-- Volcando estructura para tabla db_a6aba0_herf.tbl_producto
...
-- Volcando estructura para tabla db_a6aba0_herf.tbl_usuario
